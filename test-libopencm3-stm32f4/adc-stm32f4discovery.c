/* Test of ADC and DMA function by blinking at a different rate with analogue control
...
/* Clocks on AHB1 for GPIO D (LEDs) and C (monitor) */
	rcc_peripheral_enable_clock(&RCC_AHB1ENR, RCC_AHB1ENR_IOPDEN | RCC_AHB1ENR_IOPCEN);
...
/* The array v[] is filled with the waveform data to be output */
	...
	dma_set_memory_address(DMA2,DMA_STREAM0,(u32) v);
