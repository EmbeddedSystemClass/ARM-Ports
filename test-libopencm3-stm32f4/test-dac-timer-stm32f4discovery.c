...
DMA ISR on transfer complete is used to toggle port C1 for CRO trigger.
*/
...
To use the timer, change to stream 5 channel 3, enable DMA in timer rather than
in DAC. */
...
//	dma_channel_select(DMA1, DMA_STREAM5, DMA_SxCR_CHSEL_7);	/* DAC1 */
	dma_channel_select(DMA1, DMA_STREAM5, DMA_SxCR_CHSEL_3); /* TIM2 CC1 */
